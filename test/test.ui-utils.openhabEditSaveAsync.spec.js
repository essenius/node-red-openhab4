...
const { openhabEditSaveAsync, openhabEditCancel, ControllerChecker, ListenerManager } = require("../static/ui-utils.js");
...
describe("ui-utils openhabEditSaveAsync and openhabEditCancel", function () {
    ...
    globalThis.document = {
        ...
        // sinon.stub(document, "getElementById").returns({ value: "controller1" });
