...
class InNodeHandler extends ConsumerNodeHandler {
    constructor(node, config, controller, utils) {
        ...
        console.log("Creating InNodeHandler with concept, identifier:", config.concept, this.identifier);
        this.resourceTag = CONCEPTS[config.concept].topic(this.identifier);
    }
