...
class HealthNode extends ConsumerNodeBase {
    ...
    /** Override to make the connection status be sent out through the first channel, errors on the second, and all raw events on the third.
     * TODO: check if we can reduce the duplicate code in this method and the one in consumerNodeBase.js */
