...
const EVENT_TAGS = {
    ...
    FULL_NAME: (concept, identifier) => `${concept}/${identifier}`,
    ITEM: (itemName) => EVENT_TAGS.FULL_NAME(CONCEPTS.ITEMS, itemName),
}
...
const EVENT_TYPE_GROUPS = {
    STATE_EVENTS: [EVENT_TYPES.ITEM_STATE, EVENT_TYPES.GROUP_ITEM_STATE_CHANGED]
};
