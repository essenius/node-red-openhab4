...
const STATE_MAPPING = {
    ...
    [STATE.CONNECTED]: { fill: _NODE_STATUS.COLORS.GREEN, shape: _NODE_STATUS.SHAPES.DOT },
    [STATE.OK]: { fill: _NODE_STATUS.COLORS.GREEN, shape: _NODE_STATUS.SHAPES.DOT },
    [STATE.WARNING]: { fill: _NODE_STATUS.COLORS.YELLOW, shape: _NODE_STATUS.SHAPES.DOT },
    [STATE.ERROR]: { fill: _NODE_STATUS.COLORS.RED, shape: _NODE_STATUS.SHAPES.RING },
    [STATE.DISCONNECTED]: { fill: _NODE_STATUS.COLORS.RED, shape: _NODE_STATUS.SHAPES.RING },
